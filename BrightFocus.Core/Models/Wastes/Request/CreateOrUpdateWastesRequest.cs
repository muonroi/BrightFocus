...
namespace BrightFocus.Core.Models.Wastes.Request
{
    public class CreateOrUpdateWastesRequest
    {
        ...
        public class AutoMapperProfile : Profile
        {
            ...
            {
                _ = CreateMap<CreateOrUpdateWastesRequest, Domain.Inventory.WastesProduct>();
            }
        }
    }
}
